...
<summary><img src="https://img.shields.io/badge/%E8%AF%AD%E8%A8%80-%E7%AE%80%E4%BD%93%E4%B8%AD%E6%96%87-0366d6?style=flat&labelColor=555555" alt="语言 简体中文"></summary>
...
<tr>
<td>存储</td>
<td>仅用 `localStorage` 保存轻量 UI 状态</td>
</tr>
<tr>
<td>图片</td>
<td>**禁止**将 base64 图片写入 `localStorage`</td>
</tr>
<tr>
<td>真实感</td>
<td>保守、保持身份一致的微调</td>
...
<tr>
<td>Python 语法检查</td>
<td>`python -m py_compile server.py`</td>
</tr>
<tr>
<td>JS 语法检查</td>
<td>`node --check static\app.js`</td>
</tr>
<tr>
<td>安装依赖</td>
<td>当前无需安装</td>
...
<summary><img src="https://img.shields.io/badge/LANGUAGE-ENGLISH-2ea44f?style=flat&labelColor=555555" alt="LANGUAGE ENGLISH"></summary>
...
<tr>
<td>Generation</td>
<td>Real AI image generation required</td>
</tr>
<tr>
<td>Active model</td>
<td>`gpt-image-2`</td>
...
<tr>
<td>Gemini</td>
<td>Kept only as commented reference</td>
</tr>
<tr>
<td>Platform</td>
<td>Desktop-first web app</td>
</tr>
<tr>
<td>Gallery</td>
<td>Pinterest-style masonry</td>
</tr>
<tr>
<td>Accounts</td>
<td>Not required in V1</td>
</tr>
<tr>
<td>Storage</td>
<td>Lightweight UI state in `localStorage` only</td>
</tr>
<tr>
<td>Images</td>
<td>Do **not** store base64 images in `localStorage`</td>
</tr>
<tr>
<td>Realism</td>
<td>Conservative, identity-preserving edits</td>
</tr>
</tbody>
</table>
...
<tr>
<td>Python syntax check</td>
<td>`python -m py_compile server.py`</td>
</tr>
<tr>
<td>JS syntax check</td>
<td>`node --check static\app.js`</td>
</tr>
<tr>
<td>Install</td>
